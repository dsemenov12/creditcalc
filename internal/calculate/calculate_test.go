...
func TestCalculateMonthlyPayment(t *testing.T) {
	tests := []struct {
		...
		{1000, 5, 1, 85.61},         // Тест с суммой 1000, ставкой 5% и сроком 1 год
		{1000, 10, 2, 46.14},        // Тест с суммой 1000, ставкой 10% и сроком 2 года
		//{2000, 0, 3, 555.56},        // Тест с процентной ставкой 0%
		{1500, 7, 5, 29.7},         // Тест с суммой 1500, ставкой 7% и сроком 5 лет
		{5000, 3, 10, 48.28},        // Тест с суммой 5000, ставкой 3% и сроком 10 лет
	}
